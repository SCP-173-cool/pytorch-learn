...
def get_dataloader(config):
    ...
    train_dataset = BaseImageClsDataset(train_lst, img_transform=train_img_func)
    valid_dataset = BaseImageClsDataset(valid_lst, img_transform=valid_img_func)
    
    train_loader = DataLoader(train_dataset, batch_size=bs, shuffle=True, num_workers=workers, pin_memory=True)
    valid_loader = DataLoader(valid_dataset, batch_size=bs, shuffle=False, num_workers=workers, pin_memory=True)
